...
public class DIBS {
	...
	public DIBS(int dibsno, int memno, int prdt_no, int dibs_count, String dibs_size, String prdt_color,
	...
	public String toString() {
		return "DIBS [dibsno=" + dibsno + ", memno=" + memno + ", prdt_no=" + prdt_no + ", dibs_count=" + dibs_count
				+ ", dibs_size=" + dibs_size + ", prdt_color=" + prdt_color + ", prdt_name=" + prdt_name
				+ ", prdt_price=" + prdt_price + ", prdt_sumprice=" + prdt_sumprice + ", path=" + path + ", image="
				+ image + ", dibs_date=" + dibs_date + "]";
	}
}